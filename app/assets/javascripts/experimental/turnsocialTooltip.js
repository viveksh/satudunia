        ...
        wrap: function (t, e) {
            ...
            if (!turnsocial_has_run) {
                ...
                _.push(o({
                    ...
                    name: "twitter_user",
                    description: "Twitter user @neelesh",
                    url: "https://turnsocial.com/apps/twitter_user/bcd979c1bc978abc07fc3dee8e0f453b.json?callback=?",
                    display: function (t) {
                        var e = s.map(t, function (t) {
                            return t.created_at = l.strptime(t.created_at, "%a %b %d %H:%M:%S %z %Y"), t
                        }),
                            i = t[0].user;
                        return "https:" == document.location.protocol && (i.profile_image_url = i.profile_image_url.replace(/^http:\/\/a\d/, "https://si3")),
                        function () {
                            var t = [];
                            return t.push('<div class="ts_header"> <img class="ts_logo" src="//turnsocial.com/assets/twitter-bird-991704ef40f0ddd691f92d47de8137d6.png" /> <div class="ts_profile_pic"> <a href="http://twitter.com/', i.screen_name, '"> <img src="', i.profile_image_url, '" /> </a> </div> <div class="ts_user"> <div> <a href="http://twitter.com/', i.screen_name, '"> @', i.screen_name, " </a> </div> <div> ", i.followers_count, " Followers </div> <div> ", i.statuses_count, ' Tweets </div> </div> <div class="ts_follow"> <iframe allowtransparency="true" frameborder="0" scrolling="no" src="http://platform.twitter.com/widgets/follow_button.html?screen_name=neelesh&show_screen_name=false" style="width:200px; height:20px;"> </iframe> </div> <div class="ts_about"> <div> <span class="ts_label">Location:</span> ', i.location, ' </div> <div> <span class="ts_label">Description:</span> ', i.description, " </div> </div> </div>"), s.each(e, function (e, i) {
                                t.push(' <div class="ts_tweet"> ', m.linkify(i.text), ' <span class="ts_created_at"> ', w.relative_time(i.created_at), " via ", i.source, " </span> </div>")
                            }), t.push(""), t.join("")
                        }()
                    }
                })), d += "#ts #ts_twitter_user{width:450px}#ts #ts_twitter_user .ts_header{padding:10px}#ts #ts_twitter_user .ts_header .ts_logo{float:right;border:0;width:100px;height:82px}#ts #ts_twitter_user .ts_header .ts_profile_pic{float:left;border:0}#ts #ts_twitter_user .ts_header .ts_profile_pic img{max-width:48px;max-height:48px}#ts #ts_twitter_user .ts_header .ts_user{float:left;margin-left:10px;line-height:16px}#ts #ts_twitter_user .ts_header .ts_follow{clear:left;padding-top:7px}#ts #ts_twitter_user .ts_header .ts_about{margin-top:6px;line-height:15px}#ts #ts_twitter_user .ts_header .ts_label{font-weight:bold}#ts #ts_twitter_user .ts_tweet{clear:both;margin:5px 0;border:1px #e6e6e6 solid;overflow:auto;padding:7px;line-height:15px}#ts #ts_twitter_user .ts_tweet .ts_created_at{color:#888}\n", _.push(a({
                    name: "twitter_search",
                    description: "Twitter search for Enter Search ",
                    url: "https://turnsocial.com/apps/twitter_search/bcd979c1bc978abc07fc3dee8e0f453b.json?callback=?",
                    display: function (t) {
                        var e = s.map(t.statuses, function (t) {
                            return t.created_at = l.strptime(t.created_at, "%a %b %d %H:%M:%S %z %Y"), t
                        });
                        return function () {
                            var t = [];
                            return t.push('<div class="ts_header"> <img class="ts_logo" src="//turnsocial.com/assets/twitter-bird-991704ef40f0ddd691f92d47de8137d6.png" /> <h2>Search: Enter Search </h2> </div>'), s.each(e, function (e, i) {
                                t.push(' <div class="ts_tweet"> <a href="http://twitter.com/', i.user.screen_name, '" class="ts_image_link"> <img src="', i.user.profile_image_url_https, '" /> </a> <a href="http://twitter.com/', i.user.screen_name, '"> @', i.user.screen_name, " </a> ", m.linkify(i.text), ' <span class="ts_created_at"> ', w.relative_time(i.created_at), " </span> </div>")
                            }), t.push(""), t.join("")
                        }()
                    }
                })), d += "#ts #ts_twitter_search{width:450px}#ts #ts_twitter_search .ts_logo{float:left;border:0;width:50px;height:41px}#ts #ts_twitter_search .ts_header{padding:10px;overflow:auto}#ts #ts_twitter_search .ts_header h2{float:right;color:#F7941D;font-size:16px}#ts #ts_twitter_search .ts_header .ts_user{text-align:right;font-size:16px}#ts #ts_twitter_search .ts_header .ts_user img{float:right;border:0;padding-left:10px;vertical-align:middle;width:48px;height:48px}#ts #ts_twitter_search .ts_tweet{clear:both;margin:5px 0;border:1px #e6e6e6 solid;overflow:auto;padding:7px;line-height:15px}#ts #ts_twitter_search .ts_tweet img{border:none;width:48px;height:48px;cursor:pointer}#ts #ts_twitter_search .ts_tweet .ts_image_link{float:left;margin-right:10px}#ts #ts_twitter_search .ts_tweet .ts_created_at{color:#888}\n", _.push(n({
                    name: "tweet_button",
                    description: "Tweet about this page",
                    draw_button: function () {
                        return '<iframe allowtransparency="true" frameborder="0" scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.html" id="ts_tweet_button"></iframe>'
                    }
                })), _.push(n({
                    name: "google_plusone",
                    ...
                    name: "linkedin_share",
                    description: "Share this page on linked in",
                    draw_button: function () {
                        return u.bind("show", function () {
                            u.unbind("show", arguments.callee), s("head").append('<script src="//platform.linkedin.com/in.js" type="text/javascript"><\/script>')
                        }), '<div id="ts_linkedin"><script type="IN/Share" data-counter="right" data-showzero="true"><\/script></div>'
                    }
                })), u.bind("insert", function () {
                    x(g.visible !== !1), s("#ts .ts_bar").slideDown(), u.trigger("show"), p.track("social_bar")
                });
                var y, x = function (t) {
                        t ? (s("#ts_app_links").css("display", "inline-block"), s("#ts_hide_link img").attr("src", b.hide), y.description = "Hide the toolbar") : (s("#ts_app_links").css("display", "none"), s("#ts_hide_link img").attr("src", b.show), y.description = "Show the toolbar"), s("#ts_toolbar_arrow").animate({
                            opacity: t
                        })
                    };
                y = n({
