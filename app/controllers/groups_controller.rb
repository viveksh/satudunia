class GroupsController < ApplicationController
  ...
  def create
    ...
    @group.safe_update(%w[languages name legend description default_tags subdomain logo forum enable_mathjax enable_latex custom_favicon custom_shortcut language theme signup_type custom_css wysiwyg_editor], params[:group])
  ...
  def update
    ...
    @group.safe_update(%w[track_users name legend description default_tags subdomain logo logo_info forum enable_latex enable_mathjax
                          custom_favicon custom_shortcut language languages current_theme_id reputation_rewards daily_cap reputation_constrains
